...
"""contacts-and-coordinates-v1 driver — generate / view / tokenizer.
...
Usage::
    ...
    # Build / save / push the contacts-and-coordinates-v1 tokenizer.
    python cli.py tokenizer --save-local ./tok/
    python cli.py tokenizer --push open-athena/contacts-and-coordinates-v1-tokenizer
...
def _add_generation_common(p: argparse.ArgumentParser) -> None:
    ...
    p.add_argument("--context-length", type=int, default=CONTEXT_LENGTH,
                   help="Token budget per document; coordinates fill it.")
    ...
    # Coordinate-section knobs (SPEC → Suggested default parameters).
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_tok = sub.add_parser(
        "tokenizer",
        help="Build / save / push the contacts-and-coordinates-v1 tokenizer.",
    )
