...
* **Eric trained the best-yet 1.5B models.** On our 554-protein contact benchmark, his current best 1.5B ([#117](https://github.com/Open-Athena/MarinFold/issues/117), eval loss 2.7037) gets **R-precision 0.53** vs **0.42** for the [#61](https://github.com/Open-Athena/MarinFold/issues/61) model we were using. Still short of the structure predictors on top-K (Protenix-v2 single-seq 0.60, ESMFold2 0.79). [Plot](https://github.com/Open-Athena/MarinFold/blob/main/experiments/exp82_evals_contacts_v1_contact_prediction/plots/where_we_stand_rprecision.png), [details](https://github.com/Open-Athena/MarinFold/blob/main/experiments/exp82_evals_contacts_v1_contact_prediction/README.md).
* **All our rollout evals had `top_k=50` in them.** It suppresses contacts (rollouts asserted 0.67× the true count with it, 0.96× without) and cost ~0.011 R-precision / 0.020 AUC. Now off by default; addresses the under-generation worry from [#142](https://github.com/Open-Athena/MarinFold/issues/142).
