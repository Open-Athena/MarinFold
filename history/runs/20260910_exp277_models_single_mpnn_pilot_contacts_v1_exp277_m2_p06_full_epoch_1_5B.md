...
2026-09-13 08:04 UTC: step 239,854 / 266,345 (90.05%), train loss 2.83144, step duration 0.86965 seconds, and throughput 1.206M tokens/second. WSD linear decay continues at learning rate 0.00054758. All 113 full LM validations are recorded, with best and latest loss 3.02816105 at step 238,882. Permanent checkpoint `step-239706` committed at 08:01:44 UTC. Iris reports all 16 workers running at batch priority, zero task failures, and two automatically recovered worker preemptions. One job-level recovery so far.

2026-09-13 14:53 UTC: the run finished all 266,345 updates. W&B is terminal `finished` at global step 266,344 with final validation loss 2.98440742 and final learning rate 0.000100017; the best of 126 full validations was 2.98274279 at step 264,250. Permanent native checkpoint `checkpoints/step-266344/` and HF export `hf/step-266344/` are verified in the regional CoreWeave bucket. The 5.89 GB HF export contains two safetensor shards, index and config files, `tokenizer.json`, and `tokenizer_config.json`. Recovery driver `/bizon/exp277-train-a03` and its 16-worker child are both terminal `SUCCEEDED` at batch priority. The run completed after one job-level recovery and two Iris-managed worker preemptions, without changing the scientific configuration. End-to-end wall time was just under 73 hours including validation, recovery, checkpointing, and export.
