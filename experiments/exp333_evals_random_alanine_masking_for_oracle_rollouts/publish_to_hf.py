"""Publish exp333 rollout and timing parquets to the public HF bucket."""
...
DESTINATION = "hf://buckets/open-athena/MarinFold/data/exp333/alanine-masking-v1"
...
def bucket_cli() -> list[str]:
    ...
    if shutil.which(executable) is not None:
        ...
        if probe.returncode == 0:
            return [executable]
    return ["uvx", "--from", "huggingface-hub==1.5.0", "--with", "click>=8", "hf"]
