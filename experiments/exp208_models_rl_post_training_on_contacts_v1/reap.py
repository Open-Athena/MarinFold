...
"""Stop exp208 RL arms once training has actually finished — issue #208.
...
from outside. Stopping the driver cascades to the coordinators and their children.
    ...
    uv run python reap.py --job exp208-rl-sweep \\
        --runs plm-exp208-rl-cv1-1_5b-lr1em06-s8,plm-exp208-rl-cv1-1_5b-lr3em06-s8 \\
        --steps 150
"""
