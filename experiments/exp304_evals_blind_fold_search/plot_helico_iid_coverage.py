...
def main() -> None:
    ...
    draw(axes[1], structure, "Individual Helico structures")
    ...
    fig.text(
        0.5, 0.015,
        "Structural hit: common-position GDT-TS ≥ 0.50 and switching-region "
        "GDT-TS advantage ≥ 0.10 over the other reference.\n"
        "Each Helico prediction uses one individual MarinFold contact map; dashed line: 500 draws.",
    ...
    save_plot_with_meta(
        ...
        caption="Cumulative oracle coverage of two fold modes under the contact-map screen "
                ...
                "The structural thresholds are shown on the figure; raw GDT-TS, TM-score, and "
                "CA RMSD values are retained for threshold sensitivity analyses.",
    )
    plt.close(fig)
