...
def plot_offsets(data_dir: Path, plots_dir: Path) -> None:
    ...
    save_plot_with_meta(
        ...
        caption=(
            ...
            "of 24 ground-truth documents. Layer 1 holds two near-pure previous-token heads (0.998, 0.994) and a third splitting 0.68/0.19 over offsets 1 and 2 — a width-3 smear built out "
