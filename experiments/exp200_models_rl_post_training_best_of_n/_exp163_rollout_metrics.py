...
# experiments/exp163_models_teach_contacts_v1_to_refine_a/rollout_metrics.py.
#
# Do not edit. It exists so `phase1_parity.py` can cross-check exp200's
# token-id contact walk against exp163's text-regex scorer on REAL generations,
# inside a TPU pod that bundles only this experiment's directory. The unit tests
# import exp163's original by path; this copy is for the pod.
#
# If exp163's file ever changes, re-copy rather than patching this one — the
# whole point is that the two are byte-identical.
