...
"""Export each trained arm to a bf16 HF checkpoint on a CPU pod — issue #200.
...
PREFIX = "gs://marin-us-central1/protein-structure/MarinFold/exp200"
...
def main() -> int:
    ...
    for arm in [x.strip() for x in a.arms.split(",") if x.strip()]:
        run = f"plm-exp200-rl-cv1-1_5b-lr{arm}-{a.suffix}"
