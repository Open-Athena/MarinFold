...
"""Build Levanter passthrough caches from exp177 delta-stream parquet docs."""
...
DEFAULT_CACHE_ROOT = (
    "s3://marin-us-east-02a/protein-structure/MarinFold/"
    "exp177_contacts_delta_stream_v1/cache/2026.09.15.1"
)
DEFAULT_META_ROOT = (
    "s3://marin-us-east-02a/protein-structure/MarinFold/"
    "exp177_contacts_delta_stream_v1/cache_meta/2026.09.15.1"
)
VOCAB_SIZE = 2080
...
def finalize_ledger(cache_split: str, meta_path: str) -> None:
    ...
    print(
        f"[exp177] finalized {cache_split}: {ledger.total_num_rows} rows, "
...
def build_split(
    *,
    ...
    ctx = ZephyrContext(
        ...
        name="exp177-delta-stream-cache",
...
def main() -> None:
    ...
    parser.add_argument("--max-workers", type=int, default=int(os.environ.get("EXP177_CACHE_MAX_WORKERS", "128")))
