...
DEFAULT_OUTPUT = (
    "s3://marin-us-east-02a/protein-structure/MarinFold/"
    "exp177_contacts_delta_stream_v1/documents/2026.09.15.1/"
...
def run(args: argparse.Namespace) -> None:
    ...
    ctx.execute(ds)
    print(f"[exp177] wrote delta-stream contacts documents to {args.output}")
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--max-workers", type=int, default=int(os.environ.get("EXP177_DOCUMENTS_MAX_WORKERS", "4")))
