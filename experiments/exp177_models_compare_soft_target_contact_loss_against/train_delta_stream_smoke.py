...
DEFAULT_DATA = (
    ...
    "exp177_contacts_delta_stream_v1/documents/2026.09.15.1/shard-00000-of-03338.parquet"
)
...
def main() -> None:
    ...
    parser.add_argument("--data", default=os.environ.get("EXP177_DELTA_STREAM_DATA", DEFAULT_DATA))
    parser.add_argument("--rows", type=int, default=int(os.environ.get("EXP177_SMOKE_ROWS", "128")))
    parser.add_argument("--max-tokens", type=int, default=int(os.environ.get("EXP177_SMOKE_MAX_TOKENS", "8096")))
    parser.add_argument("--steps", type=int, default=int(os.environ.get("EXP177_SMOKE_STEPS", "100")))
    parser.add_argument("--hidden", type=int, default=int(os.environ.get("EXP177_SMOKE_HIDDEN", "512")))
    parser.add_argument("--learning-rate", type=float, default=float(os.environ.get("EXP177_SMOKE_LR", "1e-2")))
    parser.add_argument("--wandb-name", default=os.environ.get("WANDB_NAME", "exp177-delta-stream-gb200-smoke"))
    ...
    run = wandb.init(
        ...
        group="exp177-delta-stream-smoke",
        tags=["exp177", "delta-stream", "next-token", "gb200", "smoke"],
