...
APP_NAME = "protenix-contacts-eval-exp74"
...
MSA_VOLUME_NAME = "protenix-exp74-msa"
OUTPUTS_VOLUME_NAME = "exp74-protenix-runs"
...
class ProtenixWorker:
    ...
    def predict_one(
        ...
        *,
        ...
        scratch = Path("/tmp/exp74_scratch") / f"{mode}_{stem}_{int(time.time())}"
