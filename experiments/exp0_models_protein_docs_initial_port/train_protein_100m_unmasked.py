...
Usage::
    ...
    uv run iris --config=lib/iris/examples/marin.yaml job run \\
        ...
        python -m train_protein_100m_unmasked
"""
...
# WITHOUT the loss_weight_fn: every position contributes to the loss, not
# just the <d_value> bin slot inside <distance> statements.
