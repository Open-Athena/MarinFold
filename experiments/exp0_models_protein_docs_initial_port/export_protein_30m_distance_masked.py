...
Targets the run produced by ``train_protein_30m_distance_masked.py``.
...
loadable checkpoint is current. Update ``CHECKPOINT_STEP`` before running
...
Usage::
    ...
    uv run iris --config=lib/iris/examples/marin.yaml job run \\
        ...
        -- python -m export_protein_30m_distance_masked
"""

from marin.execution.executor import executor_main

from protein_train_common import build_hf_export_step
from train_protein_30m_distance_masked import (
    protein_llama_30m,
