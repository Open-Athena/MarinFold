...
Targets the run produced by ``train_protein_1_5b_distance_masked.py``.
...
Usage::
    ...
    uv run iris --config=lib/iris/examples/marin.yaml job run \\
        ...
        -- python -m export_protein_1_5b_distance_masked
"""

from marin.execution.executor import executor_main

from protein_train_common import build_hf_export_step
from train_protein_1_5b_distance_masked import (
    protein_llama_1_5b,
