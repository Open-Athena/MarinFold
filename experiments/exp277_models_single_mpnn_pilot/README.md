...
The requested single-model, full-corpus training run completed successfully with a reproducible native checkpoint and loadable HF export. Language-model validation improved from 3.90598 at step 2,114 to a best of 2.98274 near the end of the epoch. Routine contact eval-val scoring is still required before this experiment can answer whether ProteinMPNN redesign improves contacts-v1 prediction relative to the native-only exp232 winner.
