...
Full data preparation succeeded as `/bizon/exp277-prepare-a03`. The redesigned AFDB cache has 31,702,680 documents / 35,352,543,972 tokens; ESM has 130,872,044 documents / 138,755,354,859 tokens. Native and redesigned cache cardinalities, token totals, locations, and mixture weights are recorded in `data/tokenized_corpora.csv`. Both isolated tokenizer smoke caches exactly matched independent fresh tokenization for every row (199,180 documents total; `data/tokenization_smoke.csv`).
...
Monitoring milestone (2026-09-10 10:46 UTC): step 58,402 / 145,200 (40.2%), train loss 2.90834, latest validation loss 3.10894. Permanent native checkpoints are saved at steps 14,520, 29,040, 43,560, and 58,080. LR is in the stable 0.001 phase. No production restart has been required.
