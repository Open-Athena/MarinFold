...
Full-epoch monitoring (2026-09-13 08:04 UTC): step 239,854 / 266,345 (90.05%), train loss 2.83144, and 0.86965 seconds/update. WSD is in linear decay and the learning rate is 0.00054758. All 113 full LM validations are recorded in `data/epoch_validation_progress.csv`; the best and latest loss is 3.02816 at step 238,882. Permanent checkpoint step-239706 committed at 08:01:44 UTC, joining checkpoints at steps 26,634 through 213,072. The first production job failed at step 73,702 during a distributed checkpoint barrier; recovery job `/bizon/exp277-train-a03` restored step-72744 and resumed from step 72,745. Iris has since handled two worker preemptions automatically. All 16 workers remain running on 128 H100s at batch priority, with no task failures. One job-level recovery so far.
