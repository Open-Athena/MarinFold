...
Full-epoch monitoring (2026-09-13 01:16 UTC): step 213,223 / 266,345 (80.06%), train loss 2.76639, and 0.86676 seconds/update. WSD linear decay has started; learning rate is 0.00099752 after the stable 0.001 phase. One hundred full LM validations are recorded in `data/epoch_validation_progress.csv`; the best loss is 3.05770 at step 207,172 and the latest is 3.05887 at step 211,400. Permanent checkpoint step-213072 committed at 01:14:01 UTC, joining checkpoints at steps 26,634 through 186,438. The first production job failed at step 73,702 during a distributed checkpoint barrier; recovery job `/bizon/exp277-train-a03` restored step-72744 and resumed from step 72,745. Iris has since handled two worker preemptions automatically. All 16 workers remain running on 128 H100s at batch priority, with no task failures. One job-level recovery so far.
