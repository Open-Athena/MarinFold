...
index ``i`` (so the worker maps generated ``<pX>`` back to a residue).
    ...
    uv run python gen_prompts.py --targets data/targets.parquet -k 1000 \
        --out gs://marin-us-east5/protein-structure/MarinFold/exp98_rollouts_contacts_v1_train/prompts
"""
