...
mkdir -p /opt/exp292
/opt/exp292-bootstrap/bin/python -c 'import boto3,tarfile; boto3.client('"'"'s3'"'"',region_name='"'"'us-west-2'"'"').download_file('"'"'marinfold-exp91-usw2'"'"','"'"'exp292/production-v1/esm/plan-build/launches/exp292-esm-plan-v2/source.tar.gz'"'"','"'"'/opt/exp292/source.tar.gz'"'"'); tarfile.open('"'"'/opt/exp292/source.tar.gz'"'"').extractall('"'"'/opt/exp292'"'"',filter='"'"'data'"'"')'
