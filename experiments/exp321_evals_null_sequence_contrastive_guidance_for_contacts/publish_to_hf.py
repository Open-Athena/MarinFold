"""Publish the mirrored exp321 rollout artifacts to the public HF bucket."""
...
DESTINATION = "hf://buckets/open-athena/MarinFold/data/exp321/null-sequence-guidance-v1"
...
def bucket_cli() -> list[str]:
    ...
    if probe.returncode == 0:
        return [executable]
    return [
        "uvx", "--from", "huggingface-hub==1.5.0", "--with", "click>=8", "hf",
    ]


def main() -> None:
    """Sync raw development parquets without deleting unrelated bucket objects."""
